...
$repo = "watch-plat-terraform-forge"
$language = "Java"
$category = "Platform engineering"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/watch-plat-terraform-walkthrough.md")) {
...
if ($profile.lowest_case.name -ne "edge") { throw "$repo profile lowest case changed" }
