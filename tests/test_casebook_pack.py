"""Regression checks for the watch-plat-terraform-forge casebook."""
...
from casebook.harness import assert_expected, watch_plat_terraform_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_plat_terraform_forge_summary(), assert_expected())
